        ...
        return (
            <div className="form-wrapper">
                <form onSubmit={this.handleSubmit} className="col s12 m3">
                    ...
                    <button onClick={this.handleSubmitBtn} className="btn light-blue darken-3 col s5 offset-s1 add-button">Add
                <i className="material-icons right">send</i></button>
                    <button onClick={this.handleCancel} className="btn red darken-2 col s5 add-button">Cancel
